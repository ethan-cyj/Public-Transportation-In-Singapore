                    ...
                    ui.nav_panel("For Prospective Cyclists",
                        ...
                        ui.page_sidebar(
                            ui.sidebar(
                                ...
                                ui.p(""),
                                ui.card(
                                    ui.output_text_verbatim("route_instructions"),
                                    height = "430px"
                                )
                            ),
                            ui.card(
...
def server(input, output, session):
    ...
    def centroid_mrt_metrics():
        ...
        return ui.HTML(DT(Centroid_MRT_df[['weighted_score','centroid_name','MRT.Name','Planning_Area','distance','suitability','time_difference','steepness']],filters=True, maxBytes = 0,showIndex = True))
